...
/**
 * This is the extension manager of the Cronjobtask extension.
 */
public class CronjobtaskManager extends GeneratedCronjobtaskManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CronjobtaskManager.class.getName());
	 ...
	 */
	public static CronjobtaskManager getInstance()
	{
		return (CronjobtaskManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CronjobtaskConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CronjobtaskManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CronjobtaskManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CronjobtaskManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CronjobtaskManager called, current tenant: " + getTenant().getTenantID());
		}
	}
