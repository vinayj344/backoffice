 ...
 */
public class EditorOfficeManager extends GeneratedEditorOfficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EditorOfficeManager.class.getName());
	 ...
	 */
	public static EditorOfficeManager getInstance()
	{
		return (EditorOfficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(EditorOfficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EditorOfficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EditorOfficeManager called.");
		}
	}
