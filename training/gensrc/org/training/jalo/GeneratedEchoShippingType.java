...
/**
 * Generated class for type {@link de.hybris.platform.jalo.GenericItem EchoShippingType}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedEchoShippingType extends GenericItem
{
	/** Qualifier of the <code>EchoShippingType.code</code> attribute **/
	public static final String CODE = "code";
	/** Qualifier of the <code>EchoShippingType.name</code> attribute **/
	public static final String NAME = "name";
	/** Qualifier of the <code>EchoShippingType.hybrisName</code> attribute **/
	public static final String HYBRISNAME = "hybrisName";
	/** Qualifier of the <code>EchoShippingType.active</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>EchoShippingType.active</code> attribute.
	 * @return the active - Flag indicating whether this shipping type is active or not
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>EchoShippingType.active</code> attribute. 
	 * @param value the active - Flag indicating whether this shipping type is active or not
	 */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>EchoShippingType.code</code> attribute.
	 * @return the code
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>EchoShippingType.code</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>EchoShippingType.hybrisName</code> attribute.
	...
	public String getHybrisName(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedEchoShippingType.getHybrisName requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>EchoShippingType.hybrisName</code> attribute. 
	...
	public void setHybrisName(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedEchoShippingType.setHybrisName requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>EchoShippingType.name</code> attribute.
	 * @return the name
	 */
	public String getName(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedEchoShippingType.getName requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>EchoShippingType.name</code> attribute. 
	...
	public void setName(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedEchoShippingType.setName requires a session language", 0 );
		}
